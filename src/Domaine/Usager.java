...
public class Usager {
    ...
    public void setId(int id) throws BibliothequeExceptions {
        if (id <= 0) {
            throw new BibliothequeExceptions("Identifiant Usager non valide !");
        }
        this.id = id;
    }
    ...
    public void setNom(String nom) throws BibliothequeExceptions {
        if (null != nom) {
            if (nom.length() < 2) {
                throw new BibliothequeExceptions("Le nom de l'usager doit contenir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new BibliothequeExceptions("Merci de saisir le nom de l'usager");
        }
        this.nom = nom;
    }
    ...
    public void setPrenom(String prenom) throws BibliothequeExceptions {
        if (null != prenom) {
            if (prenom.length() < 3) {
                throw new BibliothequeExceptions("Le prénom de l'usager doit contenir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new BibliothequeExceptions("Merci de saisir le prénom de l'usager");
        }
        this.prenom = prenom;
    }
    ...
    public void setSexe(String sexe) throws BibliothequeExceptions {
        if (null == sexe) {
            throw new BibliothequeExceptions("Merci de préciser le sexe de l'usager");
        }
        this.sexe = sexe;
    }
    ...
    public void setAdresse(String adresse) throws BibliothequeExceptions {
        if (null != adresse) {
            if (adresse.length() < 5) {
                throw new BibliothequeExceptions("L'adresse doit contenir "
                        + "au moins 10 caractères");
            }
        } else {
            throw new BibliothequeExceptions("Merci de renseigner l'adresse de l'usager");
        }
        this.adresse = adresse;
    }
    ...
    public void setTel(String tel) throws BibliothequeExceptions {
        if (null != tel) {
            if (tel.length() < 10) {
                throw new BibliothequeExceptions("Le numero de téléphone doit se composer \n"
                        + "au moins de 10 chiffres");
            }
        } else {
            throw new BibliothequeExceptions("Merci de saisir un numéro de téléphone ");
        }
        this.tel = tel;
    }

    public void ajouter(Usager usager) throws BibliothequeExceptions {
        ...
        try {
            ...
            if (statut == 0) {
                throw new BibliothequeExceptions("Erreurs lors de l'ajout d'un usager");
            }

        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de l'ajout d'un usager", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Usager usager) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de la mise à jour de l'usager");
            }
        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de la mise à jour de l'usager ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void delete(Usager usager) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de la suppression de l'usager");
            }
        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de la suppression de l'usager ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     */
    public ArrayList<Usager> getListUsagers() throws BibliothequeExceptions {
     ...
     * @throws BibliothequeExceptions
     */
    public Usager findById(int id) throws BibliothequeExceptions {
     ...
     * @throws BibliothequeExceptions
     */
    public ArrayList<Usager> findByNom(String nom) throws BibliothequeExceptions {
    ...
    private ArrayList<Usager> find(String sql, Object... objets) throws BibliothequeExceptions {
        PreparedStatement preparedStatement = null;
