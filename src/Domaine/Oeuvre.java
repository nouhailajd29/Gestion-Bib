...
public class Oeuvre {
    ...
    public void setCategorie(String categorie) throws BibliothequeExceptions {
        if (null != categorie) {
            if (categorie.length() < 3) {
                throw new BibliothequeExceptions("Le nom de la catégorie doit contenir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new BibliothequeExceptions("Merci de saisir une catégorie ");
        }
    ...
    public void setAuteur(String auteur) throws BibliothequeExceptions {
        if (null != auteur) {
            if (auteur.length() < 3) {
                throw new BibliothequeExceptions("Le nom de l'auteur doit avoir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new BibliothequeExceptions("Merci de saisir un nom ");
        }
        this.auteur = auteur;
    }
    ...
    public void setTitre(String titre) throws BibliothequeExceptions {
        if (null != titre) {
            if (titre.length() < 3) {
                throw new BibliothequeExceptions("Le titre doit avoir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new BibliothequeExceptions("Merci de saisir le titre de l'oeuvre ");
        }
        this.titre = titre;
    }
    ...
    private boolean oeuvreExiste(Oeuvre oeuvre) throws BibliothequeExceptions {
    ...
    public void ajouter(Oeuvre oeuvre) throws BibliothequeExceptions {

        if (oeuvreExiste(oeuvre)) {
            throw new BibliothequeExceptions("Cette oeuvre est déjà ajoutée");
        }
        ...
        try {
            ...
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec d'ajout de l'oeuvre");
            }

        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de l'ajout de l'oeuvre", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Oeuvre oeuvre) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de la mise à jour de l'oeuvre");
            }
        } catch (SQLException e) {
            throw new BibliothequeExceptions("Erreurs lors de la mise à jour de l'oeuvre ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     */
    public ArrayList<Oeuvre> getListOeuvres() throws BibliothequeExceptions {
     ...
     * @throws BibliothequeExceptions
     */
    public Oeuvre findById(int id) throws BibliothequeExceptions {
...
//        return oeuvres.isEmpty() ? null : oeuvres.get(0);
//    }
    public ArrayList<Oeuvre> findByTitre(String titre) throws BibliothequeExceptions {
    ...
    private ArrayList<Oeuvre> find(String sql, Object... objets) throws BibliothequeExceptions {
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            throw new BibliothequeExceptions("Aucune oeuvre trouvée " + e.getMessage());
        } finally {
    ...
    public void delete(Oeuvre oeuvre) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de la suppression de l'oeuvre");
            }
        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de la suppression de l'oeuvre ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
