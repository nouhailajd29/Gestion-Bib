...
//                + " AND ";
    ...
    public void setId(int id) throws BibliothequeExceptions {
        if (id <= 0) {
            throw new BibliothequeExceptions("Identifiant Reservation non valide !");
        }
        this.id = id;
    }
    ...
    public void reserver(Usager usager, Oeuvre oeuvre, Date dateJour) throws BibliothequeExceptions {
        Reservation reservation = findByReservation(usager, oeuvre);
        if (null != reservation) {
            throw new BibliothequeExceptions("Vous avez déjà réservé l'oeuvre '" + oeuvre.getTitre()
        ...
        try {
            ...
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec lors de l'enregistrement de la réservation");
            }
        } catch (SQLException e) {
            throw new BibliothequeExceptions("Erreurs lors de l'enregistrement de la réservation", e.getCause());
    ...
    public void annuler(Usager usager, Oeuvre oeuvre, Reservation reservation) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de l'annulation de la réservation");
            }
        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de  l'annulation de la réservation", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public Reservation findById(int id) throws BibliothequeExceptions {
    ...
    public ArrayList<Reservation> findByDateReservaton(Date dateRes) throws BibliothequeExceptions {
    ...
    public Reservation findByReservation(Usager usager, Oeuvre oeuvre) throws BibliothequeExceptions {
    ...
    public ArrayList<Reservation> findByReservation(Oeuvre oeuvre) throws BibliothequeExceptions {
    ...
    private ArrayList<Reservation> find(String sql, Object... objets) throws BibliothequeExceptions {
        PreparedStatement preparedStatement = null;
