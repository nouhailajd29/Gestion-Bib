...
public class Exemplaire {
    ...
    public void ajouter(Oeuvre oeuvre, String etatExemplaire) throws BibliothequeExceptions {
        ...
        try {
            ...
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec d'ajout de l'exemplaire");
            }

        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de l'ajout de l'exemplaire " + e.getMessage(), e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Exemplaire exemplaire) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de la mise à jour de l'exemplaire");
            }
        } catch (SQLException e) {
            throw new BibliothequeExceptions("Erreurs lors de la mise à jour de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
    ...
    public void delete(Exemplaire exemplaire) throws BibliothequeExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new BibliothequeExceptions("Echec de la suppression de l'exemplaire");
            }
        } catch (SQLException | BibliothequeExceptions e) {
            throw new BibliothequeExceptions("Erreurs lors de la suppression de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public ArrayList<Exemplaire> getAll() throws BibliothequeExceptions {
        final String SQL_SELECT = "SELECT * FROM exemplaire ORDER BY id";
        return find(SQL_SELECT, new Object[0]);
    }

    public Exemplaire findById(int id) throws BibliothequeExceptions {
     ...
     */
    public ArrayList<Exemplaire> findExemplaireDispo(Oeuvre oeuvre) throws BibliothequeExceptions {
    ...
    public ArrayList<Exemplaire> find(Oeuvre oeuvre) throws BibliothequeExceptions {
        final String SQL_SELECT_BY_ID_IDOEUVRE = " SELECT e.*, o.Titre, o.Auteur"
                + " FROM exemplaire e, oeuvre o"
                + " WHERE e.OeuvreID = o.id"
                + " AND e.OeuvreID = ?";
    ...
    public Exemplaire find(Oeuvre oeuvre, int idExemplaire) throws BibliothequeExceptions {
        final String SQL_SELECT_BY_ID_IDOEUVRE = " SELECT e.*, o.Titre, o.Auteur"
                + " FROM exemplaire e, oeuvre o"
                + " WHERE e.OeuvreID = o.id"
                + " AND e.OeuvreID = ?"
    ...
    private ArrayList<Exemplaire> find(String sql, Object... objets) throws BibliothequeExceptions {
        PreparedStatement preparedStatement = null;
