...
public class EmpruntControl {
    ...
    public static void emprunter(int id, String titre) throws BibliothequeExceptions {
        ...
        if(null == exemplaire){
            throw new BibliothequeExceptions("Aucun exemplaire de l'oeuvre '" 
    ...
    public static void rendre(Emprunt emprunt) throws BibliothequeExceptions {
        emprunt.Rendre(emprunt);
    }
    
    public static void rendre(String nom, int idOeuvre, int idExemplaire) throws BibliothequeExceptions {
        Usager usager = new Usager();
        ...
        if (null == exemplaire) {
            throw new BibliothequeExceptions("L'exemplaire n'existe pas");
        }
        Emprunt emprunt = new Emprunt().find(usager, exemplaire.getId(), oeuvre);
        if (null == exemplaire) {
            throw new BibliothequeExceptions("L'emprunt n'existe pas");
        }
        emprunt.Rendre(emprunt);
    }
    
    public static ArrayList<Emprunt> findEmprunts(Oeuvre oeuvre) throws BibliothequeExceptions {
        Emprunt emprunt = new Emprunt();
