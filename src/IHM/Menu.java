...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Deconnecter.setBackground(new Color(0, 0, 255));
        GestionReservationsEmprunts = new javax.swing.JButton();
        GestionReservationsEmprunts.setBackground(new Color(0, 0, 255));
        GestionUsager = new javax.swing.JButton();
        GestionUsager.setBackground(new Color(0, 0, 255));
        GestionOeuvresExamplaires = new javax.swing.JButton();
        GestionOeuvresExamplaires.setBackground(new Color(0, 0, 255));
        ...
        GestionReservationsEmprunts.setForeground(new Color(255, 255, 255));
        ...
        GestionUsager.setForeground(new Color(255, 255, 255));
        ...
        GestionOeuvresExamplaires.setForeground(new Color(255, 255, 255));
